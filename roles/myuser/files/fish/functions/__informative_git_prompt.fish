...
set -g fish_color_git_changed brmagenta
set -g fish_color_git_untracked $normal_fish_color
...
function __informative_git_prompt --description 'Write out the git prompt'
    ...
    if test "true" = "$is_inside_work_tree"
        ...
        set git_status_info (set_color -o $fish_color_git_clean)$fish_prompt_git_status_git_dir(set_color $normal_fish_color)
    end

    printf "%s(%s|%s%s)" (set_color -o $normal_fish_color) (___fish_git_print_branch_info) $git_status_info  (set_color $normal_fish_color)
...
function ___fish_git_print_branch_info
    ...
    set -l color_normal (set_color $normal_fish_color)
...
function ___fish_git_print_status_info
    ...
    set -l changedAll (math "0$changed" + "0$conflicted" + "0$staged" + "0$untracked")
    if test "$changedAll" = 0
...
function ___fish_git_print_remote_info
    ...
    set color_normal (set_color $normal_fish_color)
